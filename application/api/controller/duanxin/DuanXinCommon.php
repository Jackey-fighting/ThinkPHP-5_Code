...
require_once VENDOR_PATH . 'aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php';
 ...
 * 备注:Demo工程编码采用UTF-8
 */
class DuanXinCommon extends Controller
{
     ...
     * @return stdClass
     */
    public static function sendSms($rand, $phoneNum) {
        ...
        $request->setSignName(config('aliyun.setSignName'));

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode(config('aliyun.setTemplateCode'));
